...
describe("seed", () => {
  ...
  describe("emojis table", () => {
    ...
    test("emojis table has emoji_id column as a serial", () => {
      return db
        .query(
          `SELECT column_name, data_type, column_default
            FROM information_schema.columns
  ...
  describe("emoji_article_user table", () => {
    ...
    test("emoji_article_user table has emoji_id column as a int", () => {
      return db
        .query(
          `SELECT column_name, data_type, column_default
            FROM information_schema.columns
    ...
    test("emoji_id column references a emoji_id from the emojis table", () => {
      return db
        .query(
          `
        SELECT *
    ...
    test("emoji_article_user table has username column as varying character", () => {
      return db
        .query(
          `SELECT column_name, data_type
            FROM information_schema.columns
    ...
    test("emoji_article_user table has article_id column as a int", () => {
      return db
        .query(
          `SELECT column_name, data_type
            FROM information_schema.columns
    ...
    test("article_id column references a article_id from the articles table", () => {
      return db
        .query(
          `
        SELECT *
    ...
    test("emoji_article_user table has a composite primary key (emoji_id, username, article_id)", () => {
      return db
        .query(
          `
  ...
  describe("user_topic", () => {
    ...
    test("user_topic table has username column as varying character", () => {
      return db
        .query(
          `SELECT column_name, data_type
            FROM information_schema.columns
    ...
    test("user_topic table has topic column as varying character", () => {
      return db
        .query(
          `SELECT column_name, data_type
            FROM information_schema.columns
    ...
    test("emoji_article_user table has a composite primary key (username, topic)", () => {
      return db
        .query(
          `
        SELECT kcu.column_name
        ...
        .then(({ rows }) => {
          const primaryKeyColumns = rows.map((row) => row.column_name);
          expect(primaryKeyColumns).toEqual(["username", "topic"]);
        });
    });
  });

  describe("user_article_votes", () => {
    ...
    test("user_article_votes table has article_id column as a int", () => {
      return db
        .query(
          `SELECT column_name, data_type
            FROM information_schema.columns
    ...
    test("user_article_votes table has vote_count column as int", () => {
      return db
        .query(
          `SELECT column_name, data_type
            FROM information_schema.columns
    ...
    test("vote_count column is NOT NULL", () => {
      return db
        .query(
          `SELECT is_nullable
          FROM information_schema.columns
    ...
    test("user_article_votes table has a composite primary key (username, article_id)", () => {
      return db
        .query(
          `
        SELECT kcu.column_name
        ...
        .then(({ rows }) => {
          const primaryKeyColumns = rows.map((row) => row.column_name);
          expect(primaryKeyColumns).toEqual(["username", "article_id"]);
        });
    });
  });
});
...
describe("data insertion", () => {
  ...
  test("emoji_article_user data has been inserted correctly", () => {
    return db.query(`SELECT * FROM emoji_article_user;`).then(({ rows }) => {
      expect(rows).toHaveLength(4);
      rows.forEach((row) => {
        expect(row).toHaveProperty("emoji_id");
  ...
  test("user_topic data has been inserted correctly", () => {
    return db.query(`SELECT * FROM user_topic;`).then(({ rows }) => {
      expect(rows).toHaveLength(4);
      rows.forEach((row) => {
        expect(row).toHaveProperty("username");
  ...
  test("user_article_votes data has been inserted correctly", () => {
    return db.query(`SELECT * FROM user_article_votes;`).then(({ rows }) => {
      expect(rows).toHaveLength(4);
      rows.forEach((row) => {
        expect(row).toHaveProperty("username");
        expect(row).toHaveProperty("article_id");
        expect(row).toHaveProperty("vote_count");
      });
    });
  });
});
